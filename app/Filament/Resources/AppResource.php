    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                RichEditor::make('whoweare')->required()->label('Who We Are FR'),
                RichEditor::make('whoweare_en')->required()->label('Who We Are EN')->hintIcon('heroicon-s-translate'),
                ...
                Textarea::make('email_sign')->maxLength(255)->label('Email Sign FR'),
                Textarea::make('email_sign_en')->maxLength(255)->label('Email Sign EN'),
            ]);
    }
